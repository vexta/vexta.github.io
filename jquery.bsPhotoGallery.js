(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
          ...
          html += '<a class="controls next" data-bsp-id="'+clicked.ulId+'" href="'+ (clicked.nextImg) + '">ďalší&raquo;</a>';
          html += '<a class="controls previous" data-bsp-id="'+clicked.ulId+'" href="' + (clicked.prevImg) + '">&laquo;predošlý</a>';
          html += '</div>';
